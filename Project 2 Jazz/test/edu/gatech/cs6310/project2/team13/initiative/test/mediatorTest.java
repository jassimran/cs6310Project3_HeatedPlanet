...
public class mediatorTest {
	...
	// TODO: Note from James, I've broken this... 
	public static void main(String[] args) {
		...
		MediatingConsumer mc = new MediatingConsumer(buffer);
		MediatingGenerator mg = new MediatingGenerator(buffer);
		
		MediatingController c = new MediatingController(mg,mc, buffer);
