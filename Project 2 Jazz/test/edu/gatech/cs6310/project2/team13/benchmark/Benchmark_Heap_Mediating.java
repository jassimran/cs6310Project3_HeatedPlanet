...
public class Benchmark_Heap_Mediating extends AbstractBenchmark {
	...
	public void HeatedEarth_5DR_5SI_1BS_1GS_0ST_0VT_M() throws Exception{
		System.out.print("*"+this.getClass().getSimpleName()+".HeatedEarth_5DR_5SI_1BS_1GS_0ST_0VT_M,");
		disableOutput();
	...
	public void HeatedEarth_5DR_5SI_1BS_5GS_0ST_0VT_M() throws Exception{
		System.out.print("*"+this.getClass().getSimpleName()+".HeatedEarth_5DR_5SI_1BS_5GS_0ST_0VT_M,");
		disableOutput();
	...
	public void HeatedEarth_5DR_5SI_1BS_15GS_0ST_0VT_M() throws Exception{
		System.out.print("*"+this.getClass().getSimpleName()+".HeatedEarth_5DR_5SI_1BS_15GS_0ST_0VT_M,");
		disableOutput();
	...
	public void HeatedEarth_5DR_5SI_1BS_50GS_0ST_0VT_M() throws Exception{
		System.out.print("*"+this.getClass().getSimpleName()+".HeatedEarth_5DR_5SI_1BS_50GS_0ST_0VT_M,");
		disableOutput();
